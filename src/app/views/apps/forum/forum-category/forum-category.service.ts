...
export class ForumCategoryService {
  ...
  getCategory(id:any): Observable<any[] | CommonError> {
    const url = `forums/categories/get/${id}`;
    return this.httpClient
      .get<any[]>(url)
      .pipe(catchError(this.commonHttpErrorService.handleError));
  }
  ...
  addCategory(data:any): Observable<any[] | CommonError> {
    const url = `forums/categories/create`;
    return this.httpClient
      .post<any[]>(url,data)
      .pipe(catchError(this.commonHttpErrorService.handleError));
  }
  ...
  updateCategory(id:any,data:any): Observable<any[] | CommonError> {
    const url = `forums/categories/update/${id}`;
    return this.httpClient
      .put<any[]>(url,data)
      .pipe(catchError(this.commonHttpErrorService.handleError));
  }
  ...
  deleteCategory(id:any): Observable<any[] | CommonError> {
    const url = `forums/categories/delete/${id}`;
    return this.httpClient
      .delete<any[]>(url)
      .pipe(catchError(this.commonHttpErrorService.handleError));
  }
