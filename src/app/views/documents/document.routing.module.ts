...
const routes: Routes = [
  ...
  },
  {
    path: "categories",
    loadChildren: () =>
      import("./document-categories/document-categories.module").then(
        (m) => m.DocumentCategoriesModule,
      ),
    data: {
  ...
  },
  {
    path: "audit",
    loadChildren: () =>
      import("./document-audits-trail/document-audits-trail.module").then(
        (m) => m.DocumentAuditsTrailModule,
      ),
    data: {
