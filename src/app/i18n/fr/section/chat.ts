export const chat = {
  CHAT: {
    LABELS: {
      ...
      WELCOME:
        "Sélectionnez une conversation pour commencer à discuter avec votre équipe ou vos contacts.",
      ...
      START_CHAT: "Bienvenue dans vos messages",
      ...
      SHOW_REACTIONS: "Afficher les réactions",
