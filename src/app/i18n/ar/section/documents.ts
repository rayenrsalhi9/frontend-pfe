export const documents = {
  DOCUMENTS: {
    LIST: {
      TITLE: "المستندات",
      DESCRIPTION: "إدارة وتنظيم جميع مستندات شركتك في مكان واحد آمن.",
      BUTTONS: {
        ADD: "أضف وثيقة",
        VIEW: "عرض",
        EDIT: "تعديل",
    ...
    REMINDER: {
      ...
      ERROR: {
        ...
        START_DATE_SHOULD_BE_GREATER_THEN_CURRENT_DATE_TIME:
          "يجب أن يكون تاريخ البدء أكبر من التاريخ والوقت الحاليين",
    ...
    EMAIL: {
      ...
      ERROR: {
        ...
        EMAIL_IS_NOT_PROPER_FORMAT:
          "بنية عنوان البريد الإلكتروني المرسل إليه غير صحيح",
