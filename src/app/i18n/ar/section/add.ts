export const add = {
  ADD: {
    AI: {
      ...
      GENERATED: "تمت إضافة المحتوى بالذكاء الاصطناعي",
      ERROR: "فشل إنشاء المحتوى. حاول مرة أخرى.",
      FORUM_HINT: "(الحقول العنوان والفئة مطلوبة لكي يتمكن الذكاء الاصطناعي من إنشاء المحتوى)",
      BLOG_HINT: "(الحقول العنوان والعنوان الفرعي والفئة مطلوبة لكي يتمكن الذكاء الاصطناعي من إنشاء المحتوى)",
      ARTICLE_HINT: "(الحقول العنوان والوصف والفئة مطلوبة لكي يتمكن الذكاء الاصطناعي من إنشاء المحتوى)",
    },
