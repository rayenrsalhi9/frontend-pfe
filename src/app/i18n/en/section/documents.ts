export const documents = {
  DOCUMENTS: {
    LIST: {
      TITLE: "Documents",
      DESCRIPTION:
        "Manage and organize all your company documents in one secure place.",
      BUTTONS: {
        ADD: "Add document",
        VIEW: "View",
        EDIT: "Edit",
    ...
    REMINDER: {
      ...
      ERROR: {
        ...
        START_DATE_SHOULD_BE_GREATER_THEN_CURRENT_DATE_TIME:
          "The start date must be greater than the current date and time",
    ...
    EMAIL: {
      ...
      ERROR: {
        ...
        EMAIL_IS_NOT_PROPER_FORMAT:
          "The To email address is not in a proper format",
        SUBJECT_IS_REQUIRED: "The subject filed is required",
